  ...
  <div className='w-screen h-screen flex flex-col bg-white'>
      ...
      <div className='w-[100%] h-[100%]'>
        ...
        <div className='main w-[100%] h-[60%] flex'>
            ...
            <div className='w-[100%] h-[5%] bg-blue-300 absolute flex'>
                
                <div className='w-[20%] h-[100%] bg-gray-100'>
                ...
                <div className='w-[20%] h-[100%] bg-gray-300'>

                </div>
               
                <div className='w-[40%] h-[100%] bg-red-500 flex items-center justify-end'>
                   
                    <div className='w-[20%] h-[100%] bg-blue-100 flex items-center justify-center'>
                        <button className='text-white font-semibold' onClick={toggleModal}>My Booking</button>
                    </div>
                    <div className='w-[20%] h-[100%] bg-blue-300 flex'>
                        <div className='w-[70%] h-[100%] bg-gray-300 flex items-center justify-center'>
                            <h1 className='text-white font-semibold'>{userData.FName}</h1>
                        </div>
                        <div className='w-[30%] h-[100%] bg-green-300 flex items-center justify-center'>
                            <button className='w-[70%] h-[70%] flex items-center justify-center bg-white rounded-[100%]' onClick={handleLogout}><img className='w-[100%]' src={out}></img></button>
                        </div>
                    </div>
                                        ...
                                        <div className='w-[100%] h-[90%] p-5'>
                                            ...
                                            <div className='w-[100%] h-[45%] border border-gray-200 rounded-md p-2'>
                                                ...
                                                <div className='w-[100%] h-[29.5%] flex items-center justify-center'>
                                                    <Link to={"/Payment"} state={{ cartItems }} className='w-[100%]'>
            ...
            <div className='w-[75%] flex flex-col'>
              ...
              <div className='w-[100%] h-[50px] flex items-center mt-10'>
                ...
                <div className='w-[100%] flex flex-col'>
                    ...
                    <div className='w-[100%] h-[300px] flex items-center justify-between  bg-red-300'>
